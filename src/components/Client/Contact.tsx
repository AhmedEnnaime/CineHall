                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="py-3 px-4 block border-2 border-gray-200 w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
                        />
                      </div>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="py-3 px-4 border-2 border-gray-200 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
